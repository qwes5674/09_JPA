...
public class SimpleJPQLTests {
    ...
    * 엔티티 객체를 주임으로 개발 할 수 있는 객체지향 쿼리
    * SQL보다 간결하고, 특정 DBMS에 의존하지 않는다.
    * 방언을 통해 해당 DBMS에 맞는 SQL을 설치하게 된다.
    ...
    * */
    ...
    public void test3(){
        ...
        TypedQuery<Menu> query =
                entityManager.createQuery(jpql, Menu.class); // 반환 타입을 매핑한 엔티티 타입으로 설정
    ...
    @Test
    @DisplayName("Query를 이용한 단일행 조회 테스트")
    public void test5(){
        //given
        //when
        String jpql = "select m from menu_section01 m";
