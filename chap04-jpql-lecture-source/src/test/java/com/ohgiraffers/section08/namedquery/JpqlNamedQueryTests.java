...
public class JpqlNamedQueryTests {
    ...
    void test1() {
        ...
        List<Menu> menuList =
                entityManager.
                        createNamedQuery("section08.namedquery.Menu.findAll",
                                Menu.class)
                        .getResultList();
        //then
    ...
    void test2() {
        ...
        List<Menu> menuList =
                ...
                entityManager.
                        createNamedQuery("section08.namedquery.Menu.findByMenuName",
                                Menu.class)
    ...
    void test3() {
        ...
        List<Menu> menuList =
            //select m from menu_section08 m where m.menuName like concat('%', : menuName, '%')
                entityManager.
                        createNamedQuery("section08.namedquery.Menu.findByMenuNameLike",
                                Menu.class)
                        .setParameter("menuName",menuName)
                        .getResultList();
        //then
